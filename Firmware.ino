...
#define LEDSTRIPS_PIN_SIG	4
#define RELAYGRAVITY_PIN_SIG	5
...
char menu()
{
    ...
    Serial.println(F("(2) Single Color LED Weatherproof Flexi-Strip 60 LED - (1 m)"));
    Serial.println(F("(3) Digital 5A Relay Module - Gravity"));
